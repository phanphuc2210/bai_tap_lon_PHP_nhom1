...
<div class="container">
    <div class="mt-4">
        <div class="d-flex justify-content-between align-items-center">
                <h3>Kết quả tìm kiếm cho "<?php echo $tensp; ?>"</h3>
                <?php 
                    $result = mysqli_query($conn, "SELECT * FROM san_pham WHERE Ten_sp LIKE '%". $tensp ."%'");
                    // Số sản phẩm tìm thấy được
                    $numRows = mysqli_num_rows($result);
                    echo "<span>số lượng sản phẩm tìm thấy ($numRows)</span>"
                ?>
        </div>
