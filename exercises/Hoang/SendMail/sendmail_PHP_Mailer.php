...
if(isset($_POST['gui']) && isset($_POST['toMail']) && isset($_POST['content-mail'])){
	...
	$mFrom = "hoang.pm.61cntt@ntu.edu.vn"; // Địa chỉ email của người gửi
	$nFrom = "NTU"; //mail được từ đâu, thường để tên cơ quan/công ty
	$mPass = "225769086"; //mật khẩu email của người gửi

	$mTo = $_POST['toMail']; //địa chỉ email của người nhận
	$nTo = ""; //tên người nhận

	$body = $_POST['content-mail'];//nội dung thư, định dạng HTML
